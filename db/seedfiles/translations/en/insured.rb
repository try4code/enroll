...
INSURED_TRANSLATIONS = {
  ...
  "en.insured.interactive_identity.failed_validation_html" => "<h4>Your identity could not be confirmed by Experian – the third-party service we use to verify your identity<br/>",
