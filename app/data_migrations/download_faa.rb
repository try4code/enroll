...
class DownloadFAA < MongoidMigrationTask
  def migrate
    application_ids = ENV['application_ids'] # Application IDs which need to be downloaded are passed here.
    ...
    file_name_applicants_benefit_er_address = "#{Rails.root}/hbx_report/families_with_applicants_benefit_er_address.csv"
    file_name_applicants_benefit_er_phone = "#{Rails.root}/hbx_report/families_with_applicants_benefit_er_phone.csv"
    ...
    benefits_count = 0
    benefit_er_address_count = 0
    benefit_er_phone_count = 0
    deductions_count = 0
    ...
    applicants_field_names_benefit_employer_address = %w(
                                          family_member_id
                                           benefit_id
                                           kind
                                           address_1
    ...
    applicants_field_names_benefit_employer_phone = %w(
                                          family_member_id
                                           benefit_id
                                           kind
                                           country_code
          ...
          CSV.open(file_name_applicants_income_er_address, "wb") do |income_employer_address_csv|
            ...
            CSV.open(file_name_applicants_income_er_phone, "wb") do |income_employer_phone_csv|
              ...
              CSV.open(file_name_applicants_benefit, "wb") do |benefit_csv|
                ...
                CSV.open(file_name_applicants_benefit_er_address, "wb") do |benefit_employer_address_csv|
                  benefit_employer_address_csv << applicants_field_names_benefit_employer_address
                  CSV.open(file_name_applicants_benefit_er_phone, "wb") do |benefit_employer_phone_csv|
                    benefit_employer_phone_csv << applicants_field_names_benefit_employer_phone
                            ...
                            begin
                              ...
                              applicant.benefits.each do |b|
                                benefit_csv <<[applicant.family_member_id,
                                               ...
                                               b.kind,
                                               b.insurance_kind,
                                               b.is_employer_sponsored,
                                               b.is_esi_waiting_period,
                                               b.is_esi_mec_met,
                                               b.employee_cost,
                                               b.employee_cost_frequency,
                                               b.start_on,
                                               b.end_on,
                                               b.employer_name,
                                               b.employer_id
                                ...
                                if b.employer_address.present?

                                  benefit_employer_address_csv <<[applicant.family_member_id,
                                                                  b.id,
                                                                  b.employer_address.kind,
                                                                  b.employer_address.address_1,
                                                                  b.employer_address.address_2,
                                                                  b.employer_address.address_3,
                                                                  b.employer_address.city,
                                                                  b.employer_address.county,
                                                                  b.employer_address.state,
                                                                  b.employer_address.location_state_code,
                                                                  b.employer_address.full_text,
                                                                  b.employer_address.zip,
                                                                  b.employer_address.country_name
                                  ]
                                  benefit_er_address_count=benefit_er_address_count+1

                                  benefit_employer_phone_csv <<[applicant.family_member_id,
                                                                b.id,
                                                                b.employer_phone.kind,
                                                                b.employer_phone.country_code,
                                                                b.employer_phone.area_code,
                                                                b.employer_phone.number,
                                                                b.employer_phone.extension,
                                                                b.employer_phone.primary,
                                                                b.employer_phone.full_phone_number
                                  ]
                                  benefit_er_phone_count=benefit_er_phone_count+1

                                end
                              end


                              applicant.deductions.each do |d|
                              ...
                              puts "Bad applicant Record with id: #{applicant.id}" unless Rails.env.test?
                            end
                          end
                        rescue => e
                          puts "Bad application Record with id: #{application.id}" unless Rails.env.test?
                        end
                      end #Application end
                      #end #data_hash end
    ...
    puts "----loaded to CSV from Enroll app: FAA----" unless Rails.env.test?
    puts "applications downloaded #{applications_count}" unless Rails.env.test?
    puts "applicants downloaded #{applicants_count}" unless Rails.env.test?
    puts "incomes downloaded #{incomes_count}" unless Rails.env.test?
    puts "income - employer addresses downloaded #{incomes_er_address_count}" unless Rails.env.test?
    puts "income - employer phones downloaded #{incomes_er_phone_count }" unless Rails.env.test?
    puts "benefits downloaded #{benefits_count}" unless Rails.env.test?
    puts "benefit - employer addresses downloaded #{benefit_er_address_count}" unless Rails.env.test?
    puts "benefit - employer phones downloaded #{benefit_er_phone_count }" unless Rails.env.test?
    puts "deductions downloaded #{deductions_count}" unless Rails.env.test?
  end
end
